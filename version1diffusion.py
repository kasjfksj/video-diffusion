...
class ResnetBlock(nn.Module):
    def __init__(self, dim, dim_out, *, time_emb_dim=None):
        ...
        self.temporal_conv = nn.Conv3d(dim_out, dim_out, kernel_size=(3, 1, 1), padding=(1, 0, 0))
...
class Unet3D(nn.Module):
    def __init__(self, dim, out_dim=None, dim_mults=(1, 2, 4, 8), channels=4, attn_heads=8, attn_dim_head=32, init_dim=None, init_kernel_size=7, use_sparse_linear_attn=True):
        super().__init__()
        self.channels = channels
...
def temporal_consistency_guidance(model, prev_frames, overlap_frames, w_r=1.0):
    ...
    def guidance_fn(z_t, t):
        ...
        scaled_grad = -w_r * alpha_t * grad_z_t
